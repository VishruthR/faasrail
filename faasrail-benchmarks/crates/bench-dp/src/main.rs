extern crate bench_dp;
extern crate serde_json;

use serde_json::Value;
use std::io::Read;

const DEFAULT: &str = r#"{"url":"https://httpbin.org/bytes/65536","hash":"","filename":"./bench_dp_input.bin","max_iter":200}"#;
...
fn main() {
    ...
    let out = bench_dp::main(args).expect("bench failed");
